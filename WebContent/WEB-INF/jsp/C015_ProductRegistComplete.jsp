		...
		<div style="width:600px; margin-left:auto; margin-right:auto;">
			<table>
				<tr>
					...
					<td>
						<input style="background-color:#eeffee; font-size:20px;" type="submit" name="c015_return" value="メイン画面に戻る" />
					</td>
					<td>
						<input style="background-color:#ffccee; font-size:20px;" type="submit" name="c015_logout" value="ログアウト" />
					</td>
				</tr>
			</table>
		</div>
