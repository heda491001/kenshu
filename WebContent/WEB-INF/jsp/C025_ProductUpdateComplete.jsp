		...
		<div style="width:600px; margin-left:auto; margin-right:auto;">
			<table>
				<tr>
					...
					<td>
						<input style="background-color:#eeffee; font-size:20px;" type="submit" name="c025_return" value="メイン画面に戻る" />
					</td>
					<td>
						<input style="background-color:#aaccff; font-size:20px;" type="submit" name="c025_logout" value="ログアウト" />
					</td>
				</tr>
			</table>
		</div>
